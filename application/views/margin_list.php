      ...
      <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <form class="form" action='<?php echo site_url('files/createMarginFile')?>' method="POST">
                ...
                <div class="panel-footer">
                  <button type="submit" class="btn btn-success pull-right">Gerar Arquivo de Margem</button>
                </div>
              </form>
        </div>
      </div>
