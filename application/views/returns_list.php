      ...
      <div class="col-md-12">
        ...
        <div class="table-responsive">
          ...
          function confirmMovimentProcess() {
            var confirmMessage = confirm("Deseja gerar o Arquivo de Retorno? Tenha a certeza que já ter processado o MOVGER, caso contrário, todos os lançamentos do CODFIX serão considerados como \"regeitados\".");
            if (!confirmMessage) {
              return false;
            } else {
